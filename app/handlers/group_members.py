...
async def chat_member_join(event: ChatMemberUpdated):
    ...
    await event.answer_sticker(sticker=choice(Messages.new_member_stickers))
...
async def chat_member_left(event: ChatMemberUpdated):
    ...
    await event.answer_sticker(sticker=choice(Messages.left_member_stickers))
...
async def chat_member_banned(event: ChatMemberUpdated):
    ...
    await event.answer_sticker(sticker=choice(Messages.ban_member_stickers))
